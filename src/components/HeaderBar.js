        ...
        const items = (
            <div>
                <NavLink activeStyle={{ textShadow: "2px 2px 5px #5DADE2" }} exact to="/">
                    <li>
                        <i className={ ` fas fa-home ${ this.props.darkMode ? "dark-mode-icon" : "" } ` }><span className="fa-icon-inner-text">&nbsp;Home</span></i>
                    </li>
                </NavLink>
                <NavLink activeStyle={{ textShadow: "2px 2px 5px #5DADE2" }} to="/translations">
                    <li>
                        <i className={ ` fas fa-search ${ this.props.darkMode ? "dark-mode-icon" : "" } ` }><span className="fa-icon-inner-text">&nbsp;Search</span></i>
                    </li>
                </NavLink>
                <NavLink activeStyle={{ textShadow: "2px 2px 5px #5DADE2" }} to="/about">
                    <li>
                        <i className={ ` fas fa-info-circle ${ this.props.darkMode ? "dark-mode-icon" : "" } ` }><span className="fa-icon-inner-text">&nbsp;About</span></i>
                    </li>
                </NavLink>
            </div>
        );
